 ...
 * In Tauri/native mode, calls are routed to local TypeScript services via adaptedRequest.
 */
...
export async function listTemplates(): Promise<TemplateResponse[]> {
  return adaptedRequest(
    ...
    async () => {
      const { listNotebookTemplates } = await import('../local/local-client');
      return await listNotebookTemplates() as unknown as TemplateResponse[];
    },
  );
}
...
export async function getTemplateFull(templateId: number): Promise<TemplateFull> {
  return adaptedRequest(
    ...
    async () => {
      const { getNotebookTemplateFull } = await import('../local/local-client');
      const result = await getNotebookTemplateFull(templateId);
      if (!result) throw new Error('Template not found');
      return result as unknown as TemplateFull;
    },
  );
}

/** Create a new template (shop-only — syncs down to devices) */
...
/** Add a section to a template (shop-only) */
...
/** Add an entry to a template section (shop-only) */
...
export async function getJobNotebook(jobId: number): Promise<NotebookFull> {
  return adaptedRequest(
    ...
    async () => {
      const { getJobNotebook: local } = await import('../local/services/notebook-service');
      return await local(jobId, 0) as unknown as NotebookFull;
    },
  );
}
...
export async function updateNotebook(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { updateNotebook: local } = await import('../local/services/notebook-service');
      return await local(notebookId, updates as any) as unknown as NotebookResponse;
    },
  );
}
...
export async function archiveNotebook(notebookId: number): Promise<void> {
  return adaptedRequest(
    ...
    async () => {
      const { archiveNotebook: local } = await import('../local/services/notebook-service');
      await local(notebookId);
    },
  );
}
...
export async function updateSection(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { updateNotebookSection } = await import('../local/local-client');
      return await updateNotebookSection(sectionId, updates as any) as unknown as SectionResponse;
    },
  );
}
...
export async function deleteSection(sectionId: number): Promise<void> {
  return adaptedRequest(
    ...
    async () => {
      const { deleteNotebookSection } = await import('../local/local-client');
...
export async function reorderSections(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { reorderSections: local } = await import('../local/services/notebook-service');
      await local(notebookId, orderedIds);
    },
  );
}
...
export async function updateFieldValue(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { updateFieldValue: local } = await import('../local/services/notebook-service');
      return await local(entryId, fieldUpdate as any, 0) as unknown as EntryResponse;
    },
  );
}
...
export async function assignTask(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { assignTask: local } = await import('../local/services/notebook-service');
      return await local(entryId, assignment as any, 0) as unknown as EntryResponse;
    },
  );
}
...
export async function reorderEntries(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { reorderEntries: local } = await import('../local/services/notebook-service');
      await local(sectionId, orderedIds);
    },
  );
}
...
export async function bulkUpdateTasks(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { bulkUpdateTasks: local } = await import('../local/services/notebook-service');
      return await local(entryIds, taskStatus, taskAssignedTo);
    },
  );
}
...
// =================================================================
// PERMISSIONS (shop-only — no local equivalent needed)
// =================================================================
...
// =================================================================
// TEMPLATE DUPLICATION (shop-only)
// =================================================================
...
// =================================================================
// NOTEBOOK ATTACHMENTS (shop-only — file I/O)
// =================================================================
...
export async function getJobTasks(
  ...
  return adaptedRequest(
    ...
    async () => {
      const { getJobTasks: local } = await import('../local/services/notebook-service');
      return await local(jobId, status) as unknown as EntryResponse[];
    },
  );
}
