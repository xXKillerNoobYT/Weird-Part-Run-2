...
import type {
  Supplier, SupplierCreate, SupplierUpdate, DeliveryMethod,
...
// ═══════════════════════════════════════════════════════════════
// Supplier Contacts Section — dynamic entity_contacts with
// backward-compatible fallback to hardcoded fields
// ═══════════════════════════════════════════════════════════════

interface SupplierContactsFallback {
...
function SupplierContactsSection({
  supplierId,
  canEdit,
  fallback,
}: {
...
/** Displays the old-style hardcoded contact columns as a read-only grid */
