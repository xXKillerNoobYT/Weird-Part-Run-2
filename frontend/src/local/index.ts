 ...
 *
 * This module provides offline-capable data access for Capacitor mobile apps.
...
export { trackChange, getPendingChanges, getPendingChangeCount, markSynced, pruneOldChanges } from './change-tracker';
export {
