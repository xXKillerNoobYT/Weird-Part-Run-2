...
import { DeviceOverrideHandler } from './components/DeviceOverrideHandler';
...
import PublicReportView from './features/reports/pages/PublicReportView';
...
import { KeyManagementPage } from './features/settings/pages/KeyManagementPage';
import { BluetoothPage } from './features/settings/pages/BluetoothPage';
import { SecurityAdminPage } from './features/settings/pages/SecurityAdminPage';
import { RemoteSyncPage } from './features/settings/pages/RemoteSyncPage';
import { SharedChannelsPage } from './features/settings/pages/SharedChannelsPage';
...
// AI Assistant (floating panel on every page)
...
export default function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          {/* ── Public routes (no auth, no AppShell) ────────── */}
