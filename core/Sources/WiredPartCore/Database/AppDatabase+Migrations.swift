...
extension AppDatabase {
    static func registerMigrations(_ migrator: inout DatabaseMigrator) {
        ...
        registerMigration086JobStageTemplates(&migrator)
    }
...
extension AppDatabase {
    ...
    // MARK: - 086: Job Stage Templates (GH #625 / WEI-2068)

    private static func registerMigration086JobStageTemplates(_ migrator: inout DatabaseMigrator) {
        migrator.registerMigration("086_job_stage_templates") { db in
            ...
            try db.create(index: "idx_jobs_stage_template", on: "jobs", columns: ["stage_template_id"])
            ...
            try db.execute(sql: """
                ...
                """)
            try db.create(index: "idx_jscm_template", on: "job_stage_category_map", columns: ["template_id"])
        }
    }
}
