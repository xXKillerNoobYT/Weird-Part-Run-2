...
public final class PartsService: Sendable {
    ...
    public func approveRecommendation(id: Int64, userId: Int64) throws {
        ...
        try applyRecommendationApproval(id: id, byUserId: userId)
    }
    ...
    public func approveRecommendation(id: Int64, byUserId: Int64) throws {
        ...
        try applyRecommendationApproval(id: id, byUserId: byUserId)
    }

    private func applyRecommendationApproval(id: Int64, byUserId: Int64) throws {
        try db.writer.write { dbConn in
    ...
    public func dismissRecommendation(id: Int64, byUserId: Int64, reason: String) throws {
        ...
        try applyRecommendationDismissal(id: id, byUserId: byUserId, reason: reason)
    }
    ...
    public func dismissRecommendation(id: Int64, userId: Int64, reason: String) throws {
        ...
        try applyRecommendationDismissal(id: id, byUserId: userId, reason: reason)
    }

    private func applyRecommendationDismissal(id: Int64, byUserId: Int64, reason: String) throws {
        try db.writer.write { dbConn in
            try dbConn.execute(sql: """
                UPDATE target_recommendations SET
