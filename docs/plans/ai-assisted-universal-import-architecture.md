...
Stage 1: Core import contracts and deterministic adapters

- Add core models for source adapters, extracted tables, draft rows, mapping proposals, preview decisions, and source evidence.
...
Stage 2: Mapping and supplier-aware dedupe
...
Stage 3: Digital PDF and OCR preview
...
The canonical repo currently has high branch/worktree pressure: 179 remote heads, 18 open PRs, and many registered worktrees. No stale worktree metadata was prunable on 2026-06-04. Implementation children should start in small batches and should not open parallel branches beyond Stage 1 until current branch cleanup work makes capacity clear.
