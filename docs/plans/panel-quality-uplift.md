...
- [ ] Wave 2 remainder (#1421) — **in progress on `claude/wave2-orders-craft`**, scoped per the per-area PR method: PR 1 = destructive-confirm helper + full Orders pass (craft-kit adoption 2/19 files →, context menus 0 →, confirm adoption); Settings (0/39) and Fleet (1/19) each get their own follow-up PR
