...
- [ ] Wave-2 PR 2 — **in progress on `claude/wave2-settings-craft`**: Settings area (0/39 files adopted; audit includes ctx candidates + destructive sites — DB reset and key management get special care)
- [ ] Wave-2 PR 3+: Fleet (1/19), People destructive sweep (15 count-less alerts)
