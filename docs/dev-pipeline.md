...
| Tests | **1165/1165 passing** — github-issues-sync (2026-04-10): +3 Cart Mode tests (moveBinsToArea ×2, saveUnitPlacement). Previous: 1162 (2026-04-10). | 2026-04-10 |
...
| #138 | Cart Mode — `moveBinsToArea` + `saveUnitPlacement` service gap | 10 — Xcode prompt ready | 🔴 **PARTIAL** — Service done (commit 71aa8bf, 3 tests). UI pending via PE-042: `xcode-ai/fix-prompts/PE-042-cart-mode-ui.md` | Xcode AI |
| PE-042 | Cart Mode UI — multi-bin select, Place Cart sheet, area picker (GitHub #138) | 10 — Xcode prompt ready | 🔲 **NEXT** — service layer done. Paste `PE-042-cart-mode-ui.md` into Xcode AI | Xcode AI |
