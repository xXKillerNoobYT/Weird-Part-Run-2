...
| Feature Polish | **0 active DevTODOs.** DIS-016 ✅ CLOSED. DIS-015 ✅ CLOSED. DIS-014 ✅ CLOSED. DIS-012/013 deferred to v2. PE-042 ✅ archived. **#148 ✅ RE-CLOSED 2026-04-17** (Save & Exit shipped in `IOSMovementWizard.swift` lines 121–130 / 1010–1041 — Q&A retroactively ratified in `docs/dev-qa.md` reference log; verifier Check A now PASSES so no further reopens). #151 (wrong thread resolved — direct fix queued). | 2026-04-17 |
