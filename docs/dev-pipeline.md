...
> **Last updated:** 2026-04-14 (github-issues-sync run 8 — 7 bugs fixed, 6 issues closed: #230 #228 #185 #183 #212 #209. Also verified+closed: #176 #220 (already fixed). 1237/1237 passing. Previous: test-coverage-maintenance session 2 — 3 SQL bugs, 15 new tests.)
...
| GitHub Issues | **49 open** (2026-04-14: **run 8**: CLOSED #232 (div-by-zero, already fixed), #230 (encryptIfNeeded fail-closed), #228 (SecItemAdd warning), #185 (CartManager @MainActor), #183 (ChangeTracker LIMIT), #212 (missing model columns), #209 (export sell price), #176 (status endpoint redacted — already fixed), #220 (applyUpdate skipped — already fixed). 2026-04-14 run 18 (pipeline): #231 NEW — Keychain accessibility level, #229 NEW plan drift. 2026-04-13: #151 ✅ CLOSED. **30 new issues from April audit** — #179–#228.) | 2026-04-14 |
...
| PE-DISMISS | #143/#149 — interactiveDismissDisabled systemic audit (30+ sheets) + scrollDismissesKeyboard systemic audit (30+ pages). Both bundles in `docs/dev-qa.md`. | 3 — Q&A asked | 🔲 **Awaiting owner answers** — 5 questions: priority, module order, dirty-tracking approach, Xcode vs. script, keyboard-dismiss apply scope. | owner decision |
...
> **Phase 3 active.** Q&A: **4 pending** (Colors/Brands redesign #98-#107, #143 dismiss safety, April architectural decisions #221/#223/#224/#227). Tests: **1237/1237**. **1 active Xcode prompt: PE-043.** **3 unpatched security bugs: #191, #184, #230.** Working tree uncommitted since 2026-04-12. Run 18 (2026-04-14).
...
3. 🚨 **[SECURITY] Fix #230** — `AuthService.swift` — `encryptIfNeeded()` silently falls back to storing data as plaintext when AES-GCM encryption fails. Encryption failures should throw, not silently degrade to plaintext. **Core Swift — fix directly.**
