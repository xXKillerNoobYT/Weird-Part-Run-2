...
| Tests | **1118/1118 passing** — test-coverage-maintenance (2026-04-07): +21 WarehouseService coverage tests (getMovement, previewMovement, executeMovement, getStockAtLocation, clearStagingTag/All, getPartStockLevels, zone CRUD, getPartName, getPartCode, getJobLinkForPOLine, listDistinctStockLocations, getPartStockByLocationType, getWarehouseLocationName/Names). Previous: 1097 tests (2026-04-06). | 2026-04-07 |
