...
> **Path normalization note (2026-05-25):** screenshot backlog path is now normalized to canonical `docs/Problomes/` (without trailing space). Prior entries that treated "`docs/Problomes/` missing" as an automatic pass were invalid when `docs/Problomes ` existed.
